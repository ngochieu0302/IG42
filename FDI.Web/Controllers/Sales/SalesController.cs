...
namespace FDI.Web.Controllers
{
    public class SalesController : BaseController
    {
        ...
        readonly DNSalesAPI _dnSalesApi = new DNSalesAPI();
                ...
                case ActionType.Add:
                    ...
                    if (model != null)
                    {
                        ...
                        if (lstDetail.Any())
                        {
                            ...
                            order.SalePercent = model.SalePercent + (model.VoucherPer);
                            order.SalePrice = model.SalePrice + (model.VoucherPrice ?? 0);
