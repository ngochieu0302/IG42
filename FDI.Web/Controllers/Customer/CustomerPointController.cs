...
{
    public class CustomerPointController : BaseController
    {
        //
        // GET: /CustomerPoint/
        readonly CustomerPointAPI _api = new CustomerPointAPI();
        ...
        {
            var model = new CustomerPointItem();
            if (DoAction == ActionType.Edit)
                model = _api.GetCustomerPointItem(ArrId.FirstOrDefault());
