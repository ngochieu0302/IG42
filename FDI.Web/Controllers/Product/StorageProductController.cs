...
namespace FDI.Web.Controllers
{
    ...
    {
        private readonly StorageProductAPI _api = new StorageProductAPI();
        ...
        {
            var model = _api.GetStorageProductItem(ArrId.FirstOrDefault());
            return View(model);
        }

        public ActionResult AjaxForm()
        {
            var model = new StorageProductItem();
            if (DoAction == ActionType.Edit)
                model = _api.GetStorageProductItem(ArrId.FirstOrDefault());            
        ...
        public ActionResult AutoProduct()
        {
            ...
            var ltsResults = _productApi.GetListAutoFull(query, 10, UserItem.AgencyID, int.Parse(type));
        ...
        public virtual void ExportProductsExcel(string filePath, List<StorageProductItem> lstStorageProduct)
        {
