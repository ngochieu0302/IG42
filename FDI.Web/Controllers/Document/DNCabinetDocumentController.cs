...
{
    public class DNCabinetDocumentController : BaseController
    {
        private readonly DNCabinetDocumentAPI _api = new DNCabinetDocumentAPI();
        private readonly DNDocumentRoomAPI _documentRoomApi = new DNDocumentRoomAPI();
        ...
        {
            var model = new DNCabinetDocumentItem();
            ViewBag.Action = DoAction;
            ViewBag.ActionText = ActionText;
            ViewBag.RoomID = _documentRoomApi.GetListSimple();
