...
{
    public class AddMinuteController : BaseController
    {
        private readonly AddMinuteAPI _api = new AddMinuteAPI();
        ...
        {
            var dayOff = _api.GetItemById(ArrId.FirstOrDefault());
            ViewData.Model = dayOff;
            return View();
        }
        public ActionResult AjaxForm()
        {
            var model = new AddMinuteItem
            {
                IsShow = true,
                Price = 0,
            };
