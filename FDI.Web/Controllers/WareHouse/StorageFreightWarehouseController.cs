...
{
    public class StorageFreightWarehouseController : BaseController
    {
        //
        // GET: /StorageFreightWarehouse/
        readonly StorageFreightWarehouseAPI _api = new StorageFreightWarehouseAPI();
        ...
        public ActionResult Actions()
        {
            ...
            {
                case ActionType.Add:
                    if (_api.Add(url, UserItem.AgencyID, CodeLogin(),":4000") == 0)
                    {
                        msg.Erros = true;
