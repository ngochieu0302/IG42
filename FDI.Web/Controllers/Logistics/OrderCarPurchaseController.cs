...
{
    public class OrderCarPurchaseController : BaseController
    {
        //
        // GET: /Supplie/
        ...
        {
            var obj = new OrderCarStatus[] { OrderCarStatus.AtWrokShop, OrderCarStatus.Process, OrderCarStatus.AtSupplier };
            return View(await _orderCarApi.ListItemsByStatus(Request.Url.Query, obj));
        }
