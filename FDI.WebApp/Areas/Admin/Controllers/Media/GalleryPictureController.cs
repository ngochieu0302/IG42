...
namespace FDI.Areas.Admin.Controllers
{
    ...
    {
        readonly Gallery_PictureDA _da;
        ...
        {
            var listPictureItem = _da.GetListSimpleByRequest(Request);
        ...
        {
            var model = _da.GetPictureItem(ArrId.FirstOrDefault());
            return View(model);
        }
        ...
        //{
        //    var msg = new JsonMessage { Erros = false, Message = "Update  thành công!" };
        //    try
        //    {
        //        var model = _da.GetListUrlPicture();
        //        foreach (var item in model)
        //        {
        //            if (!string.IsNullOrEmpty(item.Folder))
        //            {
        //                var f = item.Folder.Replace("/Uploads/", "");
        //                var temp = f.Split('/');
