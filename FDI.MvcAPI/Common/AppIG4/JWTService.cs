...
namespace FDI.MvcAPI.Common
{
    public class JWTService : IAuthService
    {
        ...
        /// </summary>
        public string SecretKey { get; set; } = "c2Rmd2VzZGZhc2Rmd2Vyd2U=";
        ...
        public static JWTService Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new JWTService(ConfigurationManager.AppSettings["jwt-key"]);
                }
        ...
        public string GenerateToken(IAuthContainerModel model)
        {
            ...
            SecurityTokenDescriptor securityTokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                Expires = DateTime.UtcNow.AddMinutes(Convert.ToInt32(ConfigurationManager.AppSettings["jwt-expire"])),
